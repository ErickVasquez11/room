...
import com.dramos.dummydictionaryerickvasquez.databinding.FragmentWordListBinding
...
class WordListFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        // Llamar al fragmento add, para agregar datos
        val navController = findNavController()

        binding.actionAddWord.setOnClickListener {
            val action = WordListFragmentDirections.actionWordListFragmentToFragmentNewAdd()
